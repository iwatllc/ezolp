...
$autoload['libraries'] = array('DX_Auth', 'form_validation', 'kmassets/utils', 'kmassets/asset_js', 'kmassets/asset_css', 'database', 'events', 'session');
...
$autoload['helper'] = array('url', 'form', 'date', 'security', 'ezolp_utils');
