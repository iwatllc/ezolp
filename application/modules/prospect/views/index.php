            ...
            <div class="col-12">
                ...
                <div class="panel panel-inverse" >
                        ...
                        <div class="panel-body">
                            <?php echo form_open('prospect/submit'); ?>
...
<!--                                         <label class="checkbox-inline">
                ...
                <div class="panel panel-inverse" >
                    <div class="panel-heading">
                        <h4 class="panel-title">Prospect Reports</h4>
                    </div>
                        <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="myTable" class="table table-bordered tablesorter">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($results as $row)
                                                {
                                                    echo "<tr>";
                                                        ...
                                                        echo "</td>";
                                                        echo "<td>";
                                                            echo '<span class="label label-default">' . $row->status_name . '</span>';
                                                        echo "</td>";
                                                        echo "<td>";
                                                            echo $row->creation_date;
                                                        echo "</td>";
                                                        echo "<td>";
                                                            echo '<a href="'.base_url().'/prospect/view/'.$row->id.'"><i class="fa fa-eye fa-lg"></i> <span>View</span></a>';
                                                        echo "</td>";
                                                    echo "<tr>";
                                                } ?>
                                            </tbody>
                                            ...
                                            {
                                                echo 'There are no prospect reports to display.';
                                            } ?>
                                        <?php 
                                        } else
                                        {
